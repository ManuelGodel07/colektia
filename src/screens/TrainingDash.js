...
const TrainingDash = () => {
    ...
    useEffect(() => {
        ...
        if (selectedCandidate?.name) {
            console.log("paso 1-", selectedCandidate?.name)
    ...
    {profileDetails ? (
        ...
        <p><strong>Escolaridad:</strong> {profileDetails.grade}</p>
        ...
        <p><strong>Fecha de contratación:</strong> {profileDetails.HiringDate}</p>
        <p><strong>Fecha de entrega a operaciones:</strong> {profileDetails.endDate}</p>
        ...
        <p><strong>TSAT:</strong> {profileDetails.posTest}</p>
